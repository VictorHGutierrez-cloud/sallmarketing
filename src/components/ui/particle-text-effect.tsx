...
export const SALL_MARKETING_PARTICLE_WORDS = ["Factorial HR", "SALL MARKETING"];

/** @deprecated Use SALL_MARKETING_PARTICLE_WORDS */
export const SMARTLIC_PARTICLE_WORDS = SALL_MARKETING_PARTICLE_WORDS;
